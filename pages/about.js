...
export default function AudioBufferOptions(){
    return(
        ...
        <div className="container mx-auto px-10 mb-8">
            ...
            <div className='mx:auto px-12 dark:bg-gray-900 dark:text-gray-100'>
                <p class="mb-3  dark:text-gray-400 first-line:uppercase first-line:tracking-widest first-letter:text-7xl first-letter:font-bold first-letter:text-gray-900 dark:first-letter:text-gray-100 first-letter:mr-3 first-letter:float-left">
                    睇騷是一個資源整合的網站,其唯一目標是提供一個平台令人快速查看近期有咩show睇
                </p>
                <p class=" dark:text-gray-400 first-line:tracking-widest">由於網站內的post都係由我自己手動copy落嚟的,所以可能會有所缺失,如果你係活動搞手,歡迎透過以下方法</p>
            </div>
        </div>
        </>
    )
